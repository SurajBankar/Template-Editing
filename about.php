...
<html lang="en">
    ...
    <head>
        ...
        <?php
include 'commonComponents/headerLinks.php';
?>
    </head>

    <body>
    <?php
include 'commonComponents/header.php';
?>
        ...
        <?php
include 'commonComponents/footer.php';
include 'commonComponents/footerLinks.php';
?>
    </body>
</html>